#!/usr/bin/env python3
"""Update scoring to work with available DSBS data"""

import os

# Create an updated scoring module that works with available fields
scoring_update = '''#!/usr/bin/env python3
"""
...
# Write the updated scoring module
with open('src/enrichment/scoring.py', 'w') as f:
    f.write(scoring_update)

print("✓ Updated scoring algorithm for DSBS data")
print("  - Adjusted for no email field")
print("  - More lenient health grading")
print("  - Better handling of minimal capabilities narratives")
