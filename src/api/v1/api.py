...
from .endpoints import innovation, companies, economic_intelligence, market_fragmentation, digital_gap, webhook
...
api_router.include_router(webhook.router, prefix="/stripe", tags=["stripe"])
