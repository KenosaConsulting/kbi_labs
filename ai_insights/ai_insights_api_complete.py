...
class AIInsightsGenerator:
    ...
    def _generate_openai_insights(self, params):
        ...
        try:
            ...
            response = self.client.chat.completions.create(
                model="gpt-4",
                messages=[
                    {"role": "system", "content": "You are a private equity investment analyst providing detailed company analysis. Always respond with valid JSON only."},
    ...
    def _prepare_context(self, params):
        ...
        Provide a comprehensive investment analysis. Return ONLY a valid JSON object with these exact keys:
        {{
            "recommendation": "Buy",
            "investment_score": 85,
        ...
        The recommendation must be one of: Strong Buy, Buy, Hold, Sell
